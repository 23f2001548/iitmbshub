...
export const coursesConfig = {
  Foundation: [
    ...
    },
    {
      ...
      formula: "Min(Max(0.6*F + 0.3*Max(QZ1, QZ2), 0.45*F + 0.25*QZ1 + 0.3*QZ2) + BONUS, 100)",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "0.15*QZ1 + 0.4*F + 0.25*Max(OPPE1, OPPE2) + 0.2*Min(OPPE1, OPPE2)",
      calculate: (vals) => {
  ...
  Diploma: [
    ...
    },
    {
      ...
      formula: "Min(0.05*GAA + Max(0.6*F + 0.25*Max(QZ1, QZ2), 0.4*F + 0.25*QZ1 + 0.3*QZ2) + BONUS, 100)",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "0.1*GAA + 0.3*F + 0.2*OPPE1 + 0.2*OPPE2 + 0.2*KA",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "Min(2*(0.7*Max(QZ1(20), QZ2(20)) + 0.3*Min(QZ1(20), QZ2(20))) + A(20) + F(40), 100)",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "0.05*GAA + 0.2*OPPE + 0.45*F + Max(0.2*Max(QZ1, QZ2), 0.1*QZ1 + 0.2*QZ2)",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "0.03*GAA2 + 0.02*GAA3 + 0.2*OPPE + 0.45*F + Max(0.2*Max(QZ1, QZ2), 0.1*QZ1 + 0.2*QZ2)",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "Min(0.05*GAA + 0.2*Max(OPPE1, OPPE2) + 0.45*F + Max(0.2*Max(QZ1, QZ2), 0.1*QZ1 + 0.2*QZ2) + 0.1*Min(OPPE1, OPPE2) + BONUS, 100)",
      calculate: (vals) => {
  ...
  Degree: [
    ...
    },
    {
      ...
      formula: "0.05*GAA + 0.2*QZ2 + 0.4*F + 0.1*GP1 + 0.1*GP2 + 0.1*PP + 0.05*CP",
      calculate: (vals) => {
    ...
    },
    {
      ...
      name: 'Deep Learning',
      components: [GAA, QZ1, QZ2, F, BONUS],
      formula: "Min(0.05*GAA + 0.25*QZ1 + 0.25*QZ2 + 0.45*F + BONUS, 100)",
      calculate: (vals) => {
        const { gaa = 0, qz1 = 0, qz2 = 0, f = 0, bonus = 0 } = vals;
    ...
    },
    {
      ...
      components: [GAA, QZ1, QZ2, F, BONUS],
      formula: "Min(0.1*GAA + 0.4*F + 0.25*QZ1 + 0.25*QZ2 + BONUS, 100)",
      calculate: (vals) => {
        const { gaa = 0, qz1 = 0, qz2 = 0, f = 0, bonus = 0 } = vals;
    ...
    },
    {
      ...
      formula: "0.15*GAA + 0.25*GP + 0.25*QZ2 + 0.35*F",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "0.1*GAA + 0.2*QZ1 + 0.2*OPPE1 + 0.2*OPPE2 + 0.3*F",
      calculate: (vals) => {
    ...
    },
    {
      ...
      components: [GAA, QZ1, QZ2, F, BONUS],
      formula: "Min(0.05*GAA + 0.35*F + 0.3*QZ1 + 0.3*QZ2 + BONUS, 100)",
      calculate: (vals) => {
        const { gaa = 0, qz1 = 0, qz2 = 0, f = 0, bonus = 0 } = vals;
    ...
    },
    {
      ...
      formula: "0.05*GAA + 0.15*QZ1 + 0.15*QZ2 + 0.15*QZ3 + 0.25*((NPPE1 + NPPE2 + NPPE3) / 3) + 0.25*VIVA",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "Min(0.05*GAA + 0.25*QZ2 + 0.4*P + 0.3*VIVA + BONUS, 100)",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "0.3*GAA + 0.2*QZ2 + 0.5*VIVA",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "0.075*GAA + 0.025*GRPA + 0.25*QZ1 + 0.25*QZ2 + 0.4*F",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "0.1*GAA + 0.2*QZ1 + 0.2*QZ2 + 0.25*P + 0.25*F",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "Min(0.2*GAA + 0.3*F + 0.25*OPPE1 + 0.25*OPPE2 + BONUS, 100)",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "0.05*GAA + 0.35*F + 0.2*QZ1 + 0.2*QZ2 + 0.2*NPPE",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "Min(0.3*GA + Max(0.2*QZ1 + 0.2*QZ2, 0.3*Max(QZ1, QZ2)) + 0.3*P + BONUS, 100)",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "0.1*GAA + 0.1*GP1 + 0.1*GP2 + 0.2*GP3 + 0.2*QZ2 + 0.3*F",
      calculate: (vals) => {
    ...
    },
    {
      ...
      components: [GAA, QZ1, QZ2, F],
      formula: "0.2*GAA + 0.3*F + 0.25*QZ1 + 0.25*QZ2",
      calculate: (vals) => {
        const { gaa = 0, qz1 = 0, qz2 = 0, f = 0 } = vals;
    ...
    },
    {
      ...
      formula: "0.1*GAA + 0.4*F + 0.2*QZ1 + 0.25*QZ2 + 0.05*CVA",
      calculate: (vals) => {
    ...
    },
    {
      ...
      formula: "Min(0.1*GAA + 0.1*PAA + 0.45*F + 0.35*QZ2 + BONUS, 100)",
      calculate: (vals) => {
